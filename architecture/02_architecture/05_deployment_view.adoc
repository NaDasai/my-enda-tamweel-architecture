...
Deployment_Node(cloud, "Infrastructure", "In premises") {
    Deployment_Node(cdn, "CDN", "Edge Location CDN") {
        Container(webAssets, "Web Assets", "Static files", "React build artifacts")
    }
    
    Deployment_Node(k8s, "Kubernetes Cluster", "EKS/AKS/GKE") {
        Deployment_Node(webPod, "Web Pod", "Java") {
            Container(webApp, "Web Application", "React", "Served via Nginx")
        }
        
        Deployment_Node(apiPod, "API Pods (x3)", "Java 18+") {
            Container(backend, "Backend Service", "SpringBoot", "REST API")
        }
        
        Deployment_Node(workerPod, "Worker Pods (x2)", "Java 18+") {
...
Rel(backend, middleDb, "Reads daily", "TCP/SSL")
...
|API Pods |Middle DB |1433 |Data sync
|===
